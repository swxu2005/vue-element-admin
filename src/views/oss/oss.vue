  ...
  <el-card shadow="never" class="aui-card--fill">
    <div class="mod-oss__oss">
      ...
      <el-table
        ...
        <el-table-column :label="$t('oss.url')" prop="url" header-align="center" align="center"/>
        <el-table-column :label="$t('oss.createDate')" prop="createDate" sortable="custom" header-align="center" align="center" width="180"/>
