  ...
  <el-card shadow="never" class="aui-card--fill">
    <div class="mod-activiti__process">
      ...
      <el-table
        ...
        <el-table-column :label="$t('process.id')" prop="id" header-align="center" align="center"/>
        <el-table-column :label="$t('process.deploymentId')" prop="deploymentId" header-align="center" align="center" width="80"/>
        <el-table-column :label="$t('process.name')" prop="name" header-align="center" align="center"/>
        <el-table-column :label="$t('process.key')" prop="key" header-align="center" align="center"/>
        <el-table-column :label="$t('process.version')" prop="version" header-align="center" align="center"/>
        <el-table-column :label="$t('process.resourceName')" :show-overflow-tooltip="true" prop="resourceName" header-align="center" align="center" width="100">
          <template slot-scope="scope">
            <a :href="getResourceURL(scope.row.deploymentId, scope.row.resourceName)" target="_blank">{{ scope.row.resourceName }}</a>
          </template>
        </el-table-column>
        <el-table-column :label="$t('process.diagramResourceName')" :show-overflow-tooltip="true" prop="diagramResourceName" header-align="center" align="center" width="100">
          <template slot-scope="scope">
            <a :href="getResourceURL(scope.row.deploymentId, scope.row.diagramResourceName)" target="_blank">{{ scope.row.diagramResourceName }}</a>
          </template>
        </el-table-column>
        <el-table-column :label="$t('process.deploymentTime')" prop="deploymentTime" header-align="center" align="center" width="180"/>
