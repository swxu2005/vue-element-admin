  ...
  <el-card shadow="never" class="aui-card--fill">
    <div class="mod-activiti__model">
      ...
      <el-table
        ...
        <el-table-column :label="$t('model.name')" prop="name" header-align="center" align="center"/>
        <el-table-column :label="$t('model.key')" prop="key" header-align="center" align="center"/>
        <el-table-column :label="$t('model.version')" prop="version" header-align="center" align="center"/>
        <el-table-column :label="$t('model.createTime')" prop="createTime" header-align="center" align="center" width="180"/>
        <el-table-column :label="$t('model.lastUpdateTime')" prop="lastUpdateTime" header-align="center" align="center" width="180"/>
