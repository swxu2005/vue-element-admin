<template>
  <el-dialog :visible.sync="visible" :title="!dataForm.id ? $t('add') : $t('update')" :close-on-click-modal="false" :close-on-press-escape="false">
    <el-form ref="dataForm" :model="dataForm" :rules="dataRule" label-width="120px" @keyup.enter.native="dataFormSubmitHandle()">
      ...
      <el-form-item :label="$t('user.deptName')" prop="deptName" class="dept-list">
        ...
        <el-input v-popover:deptListPopover v-model="dataForm.deptName" :readonly="true" :placeholder="$t('user.deptName')"/>
      </el-form-item>
      <el-form-item :label="$t('user.password')" :class="{ 'is-required': !dataForm.id }" prop="password">
        <el-input v-model="dataForm.password" :placeholder="$t('user.password')" type="password"/>
      </el-form-item>
      <el-form-item :label="$t('user.comfirmPassword')" :class="{ 'is-required': !dataForm.id }" prop="comfirmPassword">
        <el-input v-model="dataForm.comfirmPassword" :placeholder="$t('user.comfirmPassword')" type="password"/>
      </el-form-item>
      ...
      <el-form-item :label="$t('user.roleIdList')" prop="roleIdList" class="role-list">
        <el-select v-model="dataForm.roleIdList" :placeholder="$t('user.roleIdList')" multiple>
...
import { isEmail, isMobile } from '@/utils/yisiUtil'
export default {
  data() {
    return {
      visible: false,
