<template>
  <el-dialog :visible.sync="visible" :title="!dataForm.id ? $t('add') : $t('update')" :close-on-click-modal="false" :close-on-press-escape="false">
    <el-form ref="dataForm" :model="dataForm" :rules="dataRule" label-width="120px" @keyup.enter.native="dataFormSubmitHandle()">
      ...
      <el-form-item :label="$t('dept.parentName')" prop="parentName" class="dept-list">
        ...
        <el-input v-popover:deptListPopover v-model="dataForm.parentName" :readonly="true" :placeholder="$t('dept.parentName')">
          <i
      ...
      <el-form-item :label="$t('dept.sort')" prop="sort">
        <el-input-number v-model="dataForm.sort" :min="0" :label="$t('dept.sort')" controls-position="right"/>
      </el-form-item>
    </el-form>
