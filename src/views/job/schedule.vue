  ...
  <el-card shadow="never" class="aui-card--fill">
    <div class="mod-job__schedule">
      ...
      <el-table
        ...
        <el-table-column :label="$t('schedule.cronExpression')" prop="cronExpression" header-align="center" align="center"/>
        <el-table-column :label="$t('schedule.remark')" prop="remark" header-align="center" align="center"/>
        <el-table-column :label="$t('schedule.status')" prop="status" sortable="custom" header-align="center" align="center">
